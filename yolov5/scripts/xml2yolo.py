...
def getFileList3(filePath):
    ...
    with open(filePath,"r") as f:
        ...
        for i in range(len(xmlFiles)):
            ...
            labels_path = '/cluster/home/omarabd/rddc2020-master/yolov5/datasets/road2020/labels' 
...
def main():
    ...
    for file in xmlFiles:
        ...
        #os.path.join(sys.path[0], 'yolov5/datasets/road2020/labels')
        # Split the path in 
        # head and tail pair
        head_tail = os.path.split(imageFile)
        txtFile = os.path.join('/cluster/home/omarabd/rddc2020-master/yolov5/datasets/road2020/labels' ,head_tail[-1])

...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        #self.label_files = [self.label_location(x) for x in self.img_files]
        # Check cache
    ...
    @staticmethod
    def label_location(image):
        head_tail = os.path.split(image)
        txtFile = os.path.join('/cluster/home/omarabd/rddc2020-master/yolov5/datasets/road2020/labels_cropped' ,head_tail[-1])
